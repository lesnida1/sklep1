            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <!--TEST dodałem zakładkę opinie dla administratora -->
                        <li><a href="/<?= APP_ROOT ?>/opinia">Opinie</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
        </nav>
            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/<?= APP_ROOT ?>/produkt">Produkty</a></li>
                        <!--TEST dodałem zakładkę opinie dla zalogowanego usera -->
                        <li><a href="/<?= APP_ROOT ?>/opinia">Opinie</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="/<?= APP_ROOT ?>/produkt">Produkty</a></li>
                    <!--TEST dodałem zakładkę opinie dla zwykłego (niezalogowanego) usera -->
                    <li><a href="/<?= APP_ROOT ?>/opinia">Opinie</a></li>
                </ul>
            </div><!--/.nav-collapse -->
        </div>
